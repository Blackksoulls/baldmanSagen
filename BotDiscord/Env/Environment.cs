...
namespace BotDiscord.Env
{
    public static class Global
    {
        ...
        public static Dictionary<DiscordRoles, DiscordRole> Roles { get; set; }
    ...
    public static class GameBuilder
    {
        ...
        public static async Task CreateDiscordRoles()
        {
            ...
            Global.Roles = new Dictionary<DiscordRoles, DiscordRole>();
            ...
            Global.Roles.Add(DiscordRoles.Admin, adminRole);
            ...
            Global.Roles.Add(DiscordRoles.Player, playerRole);
            ...
            Global.Roles.Add(DiscordRoles.Spectator, spectRole);
        ...
        {
            if (e.User.GetMember().Roles.Contains(Global.Roles[DiscordRoles.Spectator]))
            {
