...
/* Command for C compiler:
   gcc -c -w -O3 -fno-strict-aliasing  -I/home/kuro/.choosenim/toolchains/nim-0.18.0/lib -o /home/kuro/Projects/PTUT/baldmanSagen/config/nimcache/stdlib_ospaths.o /home/kuro/Projects/PTUT/baldmanSagen/config/nimcache/stdlib_ospaths.c */
...
static NIM_CONST tySet_tyChar_nmiMWKVIe46vacnhAFrQvw TM_jvWQYw9bcuYhftfPX2ynPeg_4 = {
...
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_6, "\'\"\'\"\'", 5);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_7, "", 0);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_8, "\012Additional info: ", 18);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_9, "unknown OS error", 16);
STRING_LITERAL(TM_jvWQYw9bcuYhftfPX2ynPeg_10, "HOME", 4);
...
{	result = (NimStringDesc*)0;
	...
	LA3_: ;
	safe = allCharsInSet_wVfr4F6j4mVzI8ggLoMVdw(s, TM_jvWQYw9bcuYhftfPX2ynPeg_4);
	{
		if (!safe) goto LA7_;
		result = copyString(s);
		goto BeforeRet_;
	...
	LA7_: ;
	{
		...
		T11_ = nsuReplaceStr(s, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_5), ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_6));
		T10_ = rawNewString(T11_->Sup.len + 2);
appendString(T10_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_5));
...
appendString(T6_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_8));
appendString(T6_, additionalInfo);
	...
	LA1_: ;
	{
		...
		T12_ = (NimStringDesc*)0;
		T12_ = (*e).Sup.Sup.message; (*e).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_9));
...
{	result = (NimStringDesc*)0;
	T1_ = (NimStringDesc*)0;
	T2_ = (NimStringDesc*)0;
	T2_ = getEnv_9b1nh9cAHhSLlHOPz8lCk5FA(((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_10), ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_7));
	T1_ = rawNewString(T2_->Sup.len + 1);
appendString(T1_, T2_);
appendString(T1_, ((NimStringDesc*) &TM_jvWQYw9bcuYhftfPX2ynPeg_11));
	result = T1_;
	goto BeforeRet_;
	}BeforeRet_: ;
	return result;
